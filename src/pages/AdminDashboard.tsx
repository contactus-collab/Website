        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <nav className="space-y-2 mb-8 flex-1">
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="px-4 text-xs text-gray-500 uppercase tracking-wider mb-2">Calendar</p>
              <Link
                to="/admin/event-import"
                className={`block px-4 py-3 rounded-xl transition-colors ${
                  location.pathname === '/admin/event-import'
                    ? 'bg-[#ECE6FE] border-l-4 border-[#0F006A] text-[#0F006A] font-semibold'
                    : 'text-gray-700 hover:bg-[#F5F3F9]'
                }`}
                onClick={() => setSidebarOpen(false)}
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium">Event Import</span>
                </div>
              </Link>
              <Link
                to="/admin/events"
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <Link
                ...
                className={`block px-4 py-3 rounded-xl transition-colors ${
                  location.pathname === '/admin/marketing/instagram'
                    ? 'bg-[#ECE6FE] border-l-4 border-[#0F006A] text-[#0F006A] font-semibold'
                    : 'text-gray-700 hover:bg-[#F5F3F9]'
                }`}
                onClick={() => setSidebarOpen(false)}
