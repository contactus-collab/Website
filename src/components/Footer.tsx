    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Ball Four Foundation</h3>
            <p className="text-gray-400 mb-4">
              Supporting children with Neurodevelopmental Disorders (ND) and creating a more inclusive world.
            </p>
            {/* Social Media Links */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/purpose" className="text-gray-400 hover:text-white transition-colors">
                  Purpose
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>Copyright © 2024 - Ball Four Foundation | All rights reserved</p>
        </div>
      </div>
    </footer>
  )
